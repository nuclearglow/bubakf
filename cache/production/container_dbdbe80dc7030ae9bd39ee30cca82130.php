...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000693b38b3000000003afe6b0a(
...
class phpbbtemplatetwiglexer_00000000693b38b3000000003afe6b0a extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ba55db31225d075927298 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ba55db31226e464109331 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ba55db312231792997200 = array(
    ...
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, 'set_environment', array('env' => $env), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;

        return $this->valueHolder5ba55db31225d075927298->set_environment($env);
    }
    ...
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;

        return $this->valueHolder5ba55db31225d075927298->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;

        return $this->valueHolder5ba55db31225d075927298->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ba55db31226e464109331 = $initializer;
    }
    ...
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, '__get', array('name' => $name), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;

        if (isset(self::$publicProperties5ba55db312231792997200[$name])) {
            return $this->valueHolder5ba55db31225d075927298->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ba55db31225d075927298;
    ...
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;
    ...
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, '__isset', array('name' => $name), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;
    ...
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, '__unset', array('name' => $name), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;
    ...
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, '__clone', array(), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;

        $this->valueHolder5ba55db31225d075927298 = clone $this->valueHolder5ba55db31225d075927298;
    }

    public function __sleep()
    {
        $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, '__sleep', array(), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;

        return array('valueHolder5ba55db31225d075927298');
    }
    ...
    {
        return $this->initializer5ba55db31226e464109331;
    }
    ...
    {
        return $this->initializer5ba55db31226e464109331 && ($this->initializer5ba55db31226e464109331->__invoke($valueHolder5ba55db31225d075927298, $this, 'initializeProxy', array(), $this->initializer5ba55db31226e464109331) || 1) && $this->valueHolder5ba55db31225d075927298 = $valueHolder5ba55db31225d075927298;
    }
    ...
    {
        return null !== $this->valueHolder5ba55db31225d075927298;
    }
    ...
    {
        return $this->valueHolder5ba55db31225d075927298;
    }
