...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'bf_oauth_tokens', 'bf_oauth_states', 'bf_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'bf_users', $this, $this->get('dispatcher'), './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'bf_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'bf_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'bf_forums', 'bf_posts', 'bf_topics', 'bf_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('bf_captcha_questions', 'bf_captcha_answers', 'bf_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'bf_ext', './', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'bf_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'bf_migrations', './', 'php', 'bf_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './', 'php', 'bf_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'bf_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'bf_notification_types', 'bf_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bf_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'bf_notification_types', 'bf_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'bf_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'bf_profile_fields', 'bf_profile_lang', 'bf_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000516a96c20000000015a89d67(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'bf_bbcodes', 'bf_smilies', 'bf_styles', 'bf_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'bf_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'bf_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'bf_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'bf_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'bf_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'bf_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'bf_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'bf_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'bf_acl_groups',
            'tables.acl_options' => 'bf_acl_options',
            'tables.acl_roles' => 'bf_acl_roles',
            'tables.acl_roles_data' => 'bf_acl_roles_data',
            'tables.acl_users' => 'bf_acl_users',
            'tables.attachments' => 'bf_attachments',
            'tables.auth_provider_oauth_token_storage' => 'bf_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'bf_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'bf_oauth_accounts',
            'tables.banlist' => 'bf_banlist',
            'tables.bbcodes' => 'bf_bbcodes',
            'tables.bookmarks' => 'bf_bookmarks',
            'tables.bots' => 'bf_bots',
            'tables.captcha_qa_questions' => 'bf_captcha_questions',
            'tables.captcha_qa_answers' => 'bf_captcha_answers',
            'tables.captcha_qa_confirm' => 'bf_qa_confirm',
            'tables.config' => 'bf_config',
            'tables.config_text' => 'bf_config_text',
            'tables.confirm' => 'bf_confirm',
            'tables.disallow' => 'bf_disallow',
            'tables.drafts' => 'bf_drafts',
            'tables.ext' => 'bf_ext',
            'tables.extensions' => 'bf_extensions',
            'tables.extension_groups' => 'bf_extension_groups',
            'tables.forums' => 'bf_forums',
            'tables.forums_access' => 'bf_forums_access',
            'tables.forums_track' => 'bf_forums_track',
            'tables.forums_watch' => 'bf_forums_watch',
            'tables.groups' => 'bf_groups',
            'tables.icons' => 'bf_icons',
            'tables.lang' => 'bf_lang',
            'tables.log' => 'bf_log',
            'tables.login_attempts' => 'bf_login_attempts',
            'tables.migrations' => 'bf_migrations',
            'tables.moderator_cache' => 'bf_moderator_cache',
            'tables.modules' => 'bf_modules',
            'tables.notification_types' => 'bf_notification_types',
            'tables.notifications' => 'bf_notifications',
            'tables.poll_options' => 'bf_poll_options',
            'tables.poll_votes' => 'bf_poll_votes',
            'tables.posts' => 'bf_posts',
            'tables.privmsgs' => 'bf_privmsgs',
            'tables.privmsgs_folder' => 'bf_privmsgs_folder',
            'tables.privmsgs_rules' => 'bf_privmsgs_rules',
            'tables.privmsgs_to' => 'bf_privmsgs_to',
            'tables.profile_fields' => 'bf_profile_fields',
            'tables.profile_fields_data' => 'bf_profile_fields_data',
            'tables.profile_fields_options_language' => 'bf_profile_fields_lang',
            'tables.profile_fields_language' => 'bf_profile_lang',
            'tables.ranks' => 'bf_ranks',
            'tables.reports' => 'bf_reports',
            'tables.reports_reasons' => 'bf_reports_reasons',
            'tables.search_results' => 'bf_search_results',
            'tables.search_wordlist' => 'bf_search_wordlist',
            'tables.search_wordmatch' => 'bf_search_wordmatch',
            'tables.sessions' => 'bf_sessions',
            'tables.sessions_keys' => 'bf_sessions_keys',
            'tables.sitelist' => 'bf_sitelist',
            'tables.smilies' => 'bf_smilies',
            'tables.sphinx' => 'bf_sphinx',
            'tables.styles' => 'bf_styles',
            'tables.styles_template' => 'bf_styles_template',
            'tables.styles_template_data' => 'bf_styles_template_data',
            'tables.styles_theme' => 'bf_styles_theme',
            'tables.styles_imageset' => 'bf_styles_imageset',
            'tables.styles_imageset_data' => 'bf_styles_imageset_data',
            'tables.teampage' => 'bf_teampage',
            'tables.topics' => 'bf_topics',
            'tables.topics_posted' => 'bf_topics_posted',
            'tables.topics_track' => 'bf_topics_track',
            'tables.topics_watch' => 'bf_topics_watch',
            'tables.user_group' => 'bf_user_group',
            'tables.user_notifications' => 'bf_user_notifications',
            'tables.users' => 'bf_users',
            'tables.warnings' => 'bf_warnings',
            'tables.words' => 'bf_words',
            'tables.zebra' => 'bf_zebra',
...
class phpbbtemplatetwiglexer_00000000516a96c20000000015a89d67 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ba55dcea61d4437454138 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ba55dcea61e2406828762 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ba55dcea61aa151295820 = array(
    ...
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, 'set_environment', array('env' => $env), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;

        return $this->valueHolder5ba55dcea61d4437454138->set_environment($env);
    }
    ...
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;

        return $this->valueHolder5ba55dcea61d4437454138->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;

        return $this->valueHolder5ba55dcea61d4437454138->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ba55dcea61e2406828762 = $initializer;
    }
    ...
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, '__get', array('name' => $name), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;

        if (isset(self::$publicProperties5ba55dcea61aa151295820[$name])) {
            return $this->valueHolder5ba55dcea61d4437454138->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ba55dcea61d4437454138;
    ...
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;
    ...
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, '__isset', array('name' => $name), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;
    ...
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, '__unset', array('name' => $name), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;
    ...
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, '__clone', array(), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;

        $this->valueHolder5ba55dcea61d4437454138 = clone $this->valueHolder5ba55dcea61d4437454138;
    }

    public function __sleep()
    {
        $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, '__sleep', array(), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;

        return array('valueHolder5ba55dcea61d4437454138');
    }
    ...
    {
        return $this->initializer5ba55dcea61e2406828762;
    }
    ...
    {
        return $this->initializer5ba55dcea61e2406828762 && ($this->initializer5ba55dcea61e2406828762->__invoke($valueHolder5ba55dcea61d4437454138, $this, 'initializeProxy', array(), $this->initializer5ba55dcea61e2406828762) || 1) && $this->valueHolder5ba55dcea61d4437454138 = $valueHolder5ba55dcea61d4437454138;
    }
    ...
    {
        return null !== $this->valueHolder5ba55dcea61d4437454138;
    }
    ...
    {
        return $this->valueHolder5ba55dcea61d4437454138;
    }
